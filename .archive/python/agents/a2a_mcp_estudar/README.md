...
GOOGLE_API_KEY=AIzaSyBb1eDoRJmNdrwSi9ii0lF_rL4epIncsMo uv run python -m a2a_mcp.agents --agent-card agent_cards/orchestrator_agent.json --host localhost --port 10101
